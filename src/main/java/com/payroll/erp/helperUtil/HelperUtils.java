package com.payroll.erp.helperUtil;
...
//    public static String FILEPATH = "https://icg.net.in/cgbmsreport/";
    ...
    public static String getUserId() {return "USR_ID" + ConverterUtils.getRandomTimeStamp();}
    ...
    public static Timestamp getCurrentTimeStamp() {return new Timestamp(new Date().getTime());}

    public static String getOtp() {return  ConverterUtils.generateOTP();}
